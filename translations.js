  ...
  ru: {
    ...
    faq: {
      ...
      q7: {
        ...
        answer:
          "Стоимость зависит от объема: лендинги от 1500 AED. Ведение рекламы обычно 3000–6000 AED в месяц, зависит от бюджета и сложности. Обсудим ваш бюджет — предложу адекватный вариант.",
      },
      q8: {
